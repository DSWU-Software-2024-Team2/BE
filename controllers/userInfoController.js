...
const getUserInfo = async (req, res) => {
  ...
  try {
      ...
      // 기본 프로필 이미지 URL
      const defaultProfilePicture = 'https://ibb.co/qg68c7y'; // 기본 이미지 URL 설정
      ...
      const userInfo = {
          ...
          profilePicture: user.profile?.profile_picture || defaultProfilePicture // 프로필 이미지가 null일 경우 기본 이미지 URL 반환
      };
